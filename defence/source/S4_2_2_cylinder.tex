...
\begin{figure}[h!]
  \centering
  \subfigure[Velocity convergence]{\label{fig:IMEX_RK_vel_cyl_impl_expl}\includegraphics[width=0.49\textwidth]{Figures/vel_impl_expl}}    
  \subfigure[Pressure convergence]{\label{fig:IMEX_RK_pre_cyl_impl_expl}\includegraphics[width=0.49\textwidth]{Figures/pre_impl_expl}}
