...
\usepackage[backend=bibtex,style=ieee,natbib=false,isbn=false,doi=false,url=false,sorting=nyt]{biblatex} % User the bibtex backend with the authoryear citation style (which resembles APA)
