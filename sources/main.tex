...
\department{Departament de Resistència de Materials i Estructures a l'Enginyeria} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
