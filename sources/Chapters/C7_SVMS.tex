...
The TCF test is solved from $ t=0.0 $ to $ t=300.0 $, storing the statistics from the last $ 10.0 $ seconds, accumulating more than $ 1000 $ samples. The results are shown in \Fig{cha_vel}, where the mean stream-wise velocity is plotted (\Fig{cha_umean}) together with the velocity fluctuations in the stream-wise, wall-normal and span-wise directions (Figs. \ref{fig-cha_ufluc}, \ref{fig-cha_vfluc} and \ref{fig-cha_wfluc}, respectively).
\begin{figure}[h!]
	\centering	
	\subfigure[Mean stream-wise velocity]{\label{fig-cha_umean}\includegraphics[width=0.49\textwidth]{Figures/Chapter7/TCF/umean}}
	\subfigure[Rms stream-wise velocity fluctuation]{\label{fig-cha_ufluc}\includegraphics[width=0.49\textwidth]{Figures/Chapter7/TCF/ufluc}}\\   
  	...
  	\subfigure[Rms span-wise velocity fluctuation]{\label{fig-cha_wfluc}\includegraphics[width=0.49\textwidth]{Figures/Chapter7/TCF/wfluc}}
