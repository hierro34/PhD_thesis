In this section we will briefly state the basic concepts that one have to know about fluid mechanics and its mathematical description, which will be used in the forthcoming chapters.
