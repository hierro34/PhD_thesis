...
In order to check the performance of the convection-only OSS stabilization of ISS elements for a LES simulation, we analyse its behaviour in the TGV flow, extensively described in Section \ref{subsubsec-C3_TGV}. 
