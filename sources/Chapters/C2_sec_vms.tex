...
\begin{itemize}
\item The influence of the constants $c_1$ and $c_2$ is discussed in Section \ref{subsec-C4_effect_const}. A theoretical way to determine them would be to impose that the numerical dissipation they introduce be equal to the molecular dissipation in turbulent regimes, as explained in~\cite{guasch_statistical_2013}. 
